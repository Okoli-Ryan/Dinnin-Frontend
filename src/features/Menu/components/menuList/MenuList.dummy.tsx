...
const Dummy__MostPopular = [
	new MenuItem({
		...
		imageSrc: DummyFood,
		description:
			"Grilled medium & finished with our chimichurri sauce, served with white rice and sautéed vegetables , substitute asana lime and ginger sauce.",
	}),
	new MenuItem({
		id: "2",
		menuItemName: "Food 1",
	...
	(category, key) =>
		new TabItemType({
			children: (
				<List
					data={category.menu}
					renderItem={(item) => <OrderMenuItem {...item} id={item!.id} />}
				/>
			),
